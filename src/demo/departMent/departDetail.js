...
class departDetail extends React.Component {
    state: State;
    ...
    renderList() {
        return (
            <View paddingT-s6 marginH-s4>
                <View><YSdetailField label={YSI18n.get('部门名称')} value={datas[0].department} /></View>
                <View><YSdetailField label={YSI18n.get('所属上级')} value={datas[0].Superior} /></View>
                <View><YSdetailField label={YSI18n.get('部门人数')} value={datas[0].online} 人 /></View>
                <View><YSdetailField label={YSI18n.get('当前状态')} value={datas[0].state} /></View>
            </View>
        ...
        return (
            <View flex bg-white>
                ...
                <Modal onRequestClose={this.viewCallback} visible={this.state.editMode === 'Edit'} animationType={'fade'}>
                    <View bg-white flex>
                        <EditDepartInfo editMode={'Edit'} viewCallback={this.viewCallback} />
                    </View>
                </Modal>
            </View>
